...
import IconXacNhanThanhToan from "../assets/image/XacNhanThanhToanIcon.png";
import IconGhiSoNuoc from "../assets/image/GhiSoNuoc.png";
import MainImage from "../assets/image/imageMainScreen.jpg";
import IconUser from "../assets/image/user_no_image.png";
  ...
  return (
    <ImageBackground style={styles.background} source={MainImage}>
      <SafeAreaView style={styles.container}>
        <ScrollView>
          {/* Dua icon sang phai man hinh */}
          <View style={{ alignItems: "flex-end" }}>
            <View style={styles.squareIconUser}>
          ...
          <View style={styles.squareButton}>
            <Pressable style={styles.button} backgroundColor={"#FA4616"}>
